...
def encrypt_message(message):
    ...
    print(f"   Padded     : {repr(padded_message)}")
    print(f"   DES Key    : {KEY}")
    print(f"   Block Size : 64-bit")
    print(f"   Rounds     : 16")
    print(f"   Encrypted  : {encrypted_base64}")
    print("-" * 50)
...
def decrypt_message(encrypted_message):
    ...
    print(f"   Block Size : 64-bit")
    print(f"   Rounds     : 16")
    print(f"   Decrypted  : {repr(decrypted_message)}")
...
def main():
    ...
    print("Chat Room dimulai! Ketik 'quit' untuk keluar")
    print("Anda akan melihat proses enkripsi/dekripsi DES")
    print("=" * 60)
